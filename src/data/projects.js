...
export const projects = [
  // === CONSTRUCTION NEUF (34 images → 3 projects) ===
  {
    ...
    coverImage: '/images/projects/construction-neuf/cover.jpg',
  ...
  },
  {
    ...
    category: 'construction-neuf',
    location: 'Derval (44)',
    coverImage: '/images/projects/construction-neuf/13.jpg',
  ...
  },
  {
    ...
    category: 'construction-neuf',
    location: 'Nozay (44)',
    coverImage: '/images/projects/construction-neuf/23.jpg',
  ...
  // === ENDUIT IMITATION PIERRE (38 images → 4 projects) ===
  {
    ...
    location: 'Châteaubriant (44)',
    coverImage: '/images/projects/enduit-imitation-pierre/cover.jpg',
  ...
  },
  {
    ...
    category: 'enduit-imitation-pierre',
    location: 'Rougé (44)',
    coverImage: '/images/projects/enduit-imitation-pierre/11.jpg',
  ...
  },
  {
    ...
    category: 'enduit-imitation-pierre',
    location: 'Soudan (44)',
    coverImage: '/images/projects/enduit-imitation-pierre/21.jpg',
  ...
  },
  {
    ...
    coverImage: '/images/projects/enduit-imitation-pierre/31.jpg',
  ...
  // === GOUTTIÈRE EN ALUMINIUM (3 images → 1 project) ===
  {
    ...
    location: 'Châteaubriant (44)',
    coverImage: '/images/projects/gouttiere-aluminium/cover.jpg',
  ...
  // === ISOLANT EXTÉRIEUR (5 images → 1 project) ===
  {
    ...
    location: 'Châteaubriant (44)',
    coverImage: '/images/projects/isolant-exterieur/cover.jpg',
  ...
  // === RÉNOVATION (16 images → 2 projects) ===
  {
    ...
    category: 'renovation',
    location: 'Châteaubriant (44)',
    coverImage: '/images/projects/renovation/cover.jpg',
  ...
  },
  {
    ...
    category: 'renovation',
    location: 'Erbray (44)',
    coverImage: '/images/projects/renovation/09.jpg',
